...
import { getExceptionsQuerySchema, resolveExceptionSchema, } from "../schemas/onboarding.schema.js";
export async function onboardingRoutes(app) {
    app.register(async (authApp) => {
        ...
        authApp.get("/exceptions", {
            preHandler: [adminOnly],
            schema: {
                querystring: getExceptionsQuerySchema,
            },
        }, onboardingCaseController.getExceptions);
        authApp.post("/exceptions/:caseId/resolve", {
            preHandler: [adminOnly],
            schema: {
                body: resolveExceptionSchema,
            },
        }, onboardingCaseController.resolveException);
    });
}
