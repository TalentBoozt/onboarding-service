...
export class SuperAdminController {
    ...
    // 1. Search & Telemetry
    // ---------------------------------------------------------------------------
    searchGlobal = async (request, reply) => {
    ...
    getTelemetry = async (request, reply) => {
    ...
    getFeatureAdoption = async (request, reply) => {
        const { timeWindowDays = "30", featureKey } = request.query;
    ...
    getActivityLogs = async (_request, reply) => {
    ...
    // 2. Organizations
    // ---------------------------------------------------------------------------
    getOrganizations = async (request, reply) => {
    ...
    createOrganization = async (request, reply) => {
        const actorUserId = request.user?.userId;
        const data = await this.superAdminService.createOrganization(request.body, actorUserId);
    ...
    updateOrganizationStatus = async (request, reply) => {
        const { id } = request.params;
        const { status } = request.body;
        const actorUserId = request.user?.userId;
        const data = await this.superAdminService.updateOrganizationStatus(id, status, actorUserId);
        return reply.status(200).send({
            success: true,
    ...
    updateOrganization = async (request, reply) => {
        const { id } = request.params;
        const actorUserId = request.user?.userId;
        const data = await this.superAdminService.updateOrganization(id, request.body, actorUserId);
        return reply.status(200).send({
            success: true,
    ...
    getOrganization360 = async (request, reply) => {
        const { id } = request.params;
    ...
    quarantineOrganization = async (request, reply) => {
        const { id } = request.params;
        const { reason } = request.body || {};
        const actorUserId = request.user?.userId;
        const data = await this.superAdminService.quarantineOrganization(id, reason, actorUserId);
        return reply.status(200).send({
            success: true,
    ...
    activateOrganization = async (request, reply) => {
        const { id } = request.params;
        const actorUserId = request.user?.userId;
        const data = await this.superAdminService.updateOrganizationStatus(id, "Active", actorUserId);
        return reply.status(200).send({
            success: true,
    ...
    getUser360 = async (request, reply) => {
        const { id } = request.params;
    ...
    updateUser = async (request, reply) => {
        const { id } = request.params;
        const actorUserId = request.user?.userId;
        const data = await this.superAdminService.updateUser(id, request.body, actorUserId);
        return reply.status(200).send({
            success: true,
    ...
    forceLogoutUser = async (request, reply) => {
        const { id } = request.params;
        const actorUserId = request.user?.userId;
        const email = await this.superAdminService.forceLogoutUser(id, actorUserId);
        return reply.status(200).send({
            success: true,
    ...
    getInvoiceById = async (request, reply) => {
        const { id } = request.params;
    ...
    createInvoice = async (request, reply) => {
        const actorUserId = request.user?.userId;
        const data = await this.superAdminService.createInvoice(request.body, actorUserId);
        return reply.status(201).send({
            success: true,
    ...
    exportInvoices = async (_request, reply) => {
    ...
    getFinance = async (_request, reply) => {
    ...
    exportFinance = async (_request, reply) => {
        reply.header("Content-Type", "text/csv");
    ...
    getPayments = async (_request, reply) => {
    ...
    recordPayment = async (request, reply) => {
        const actorUserId = request.user?.userId;
        const actorUserEmail = request.user?.email;
        const data = await this.superAdminService.recordPayment(request.body, actorUserId, actorUserEmail);
        return reply.status(201).send({
            success: true,
    ...
    getExpenses = async (request, reply) => {
    ...
    recordExpense = async (request, reply) => {
        const actorUserId = request.user?.userId;
        const actorUserEmail = request.user?.email;
        const data = await this.superAdminService.recordExpense(request.body, actorUserId, actorUserEmail);
        return reply.status(201).send({
            success: true,
    ...
    getCustomerAccounts = async (request, reply) => {
        const { results, total } = await this.superAdminService.getCustomerAccounts(request.query);
        return reply.status(200).send({
            success: true,
    ...
    updateCustomerAccount = async (request, reply) => {
        const { id } = request.params;
        const actorUserId = request.user?.userId;
        const actorUserEmail = request.user?.email;
        const data = await this.superAdminService.updateCustomerAccount(id, request.body, actorUserId, actorUserEmail);
        return reply.status(200).send({
            success: true,
    ...
    // ---------------------------------------------------------------------------
    getOnboardingCases = async (request, reply) => {
        const data = await this.superAdminService.getOnboardingCases(request.query);
        return reply.status(200).send({
            success: true,
    ...
    getTasksOps = async (request, reply) => {
    ...
    getActivity = async (request, reply) => {
    ...
    getInfrastructureObservability = async (_request, reply) => {
    ...
    getAiUsage = async (request, reply) => {
    ...
    createFlag = async (request, reply) => {
        const actorUserId = request.user?.userId;
        const data = await this.superAdminService.createFlag(request.body, actorUserId);
        const key = request.body?.key?.trim().toLowerCase();
        return reply.status(201).send({
            success: true,
    ...
    updateFlag = async (request, reply) => {
        const { key } = request.params;
        const actorUserId = request.user?.userId;
        const data = await this.superAdminService.updateFlag(key, request.body, actorUserId);
    ...
    updateAlertStatus = async (request, reply) => {
        const { id } = request.params;
        const { status } = (request.body || {});
        const actorUserId = request.user?.userId;
        try {
            const data = await this.superAdminService.updateAlertStatus(id, request.body, actorUserId);
            return reply.status(200).send({
                success: true,
    ...
    exportReport = async (request, reply) => {
        const { reportId } = request.params;
        const { format } = (request.query || {});
        const actorUserId = request.user?.userId;
        try {
            const generated = await this.superAdminService.exportReport(reportId, format, actorUserId);
    ...
    getPlatformSettings = async (_request, reply) => {
    ...
    updatePlatformSettings = async (request, reply) => {
        const actorUserId = request.user?.userId;
        const data = await this.superAdminService.updatePlatformSettings(request.body, actorUserId);
        return reply.status(200).send({
            success: true,
