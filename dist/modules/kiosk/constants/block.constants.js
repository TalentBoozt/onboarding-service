 ...
 */
export const KIOSK_VIDEO_ASPECT_RATIOS = ["landscape", "portrait"];
/**
 * Available touch target sizing for icons.
 */
export const KIOSK_ICON_SIZES = ["small", "medium", "large", "oversized"];
/**
 * Color semantic themes for warning and indicator icons.
 */
export const KIOSK_ICON_THEMES = ["mandatory", "warning", "danger", "info"];
/**
 * Permitted text block sizes, keeping text small for accessibility limits.
 */
export const KIOSK_TEXT_SIZES = ["small", "medium", "large"];
/**
