...
export class StructuredDataService {
    ...
    isStructuredQuery(query) {
        ...
        if (q.includes("who is my manager") ||
        ...
        if (q.includes("what is our company name") ||
        ...
        if (q.includes("how many employees have completed onboarding") ||
     ...
     */
    async resolveStructuredQuery(orgId, userId, query) {
        const q = query.toLowerCase().trim();
        ...
        if (q.includes("buddy")) {
            ...
            if (activeAssignment && activeAssignment.buddyId) {
                const buddy = activeAssignment.buddyId;
