...
export async function auditLogRoutes(app) {
    ...
    app.get("/export", controller.exportLogs);
    // GET /api/v1/audit-logs/security
    app.get("/security", controller.getSecurityLogs);
    // GET /api/v1/audit-logs/user/:userId
    app.get("/user/:userId", controller.getUserLogs);
    // GET /api/v1/audit-logs/resource/:resourceType/:resourceId
    app.get("/resource/:resourceType/:resourceId", controller.getResourceLogs);
    // GET /api/v1/audit-logs/:id
    app.get("/:id", controller.getLogDetails);
    // GET /api/v1/audit-logs
    app.get("/", controller.listLogs);
}
