export class AuditLogController {
    ...
    getLogDetails = async (request, reply) => {
        const user = request.user;
    ...
    exportLogs = async (request, reply) => {
        const user = request.user;
        const query = request.query;
        const filter = {
            organizationId: user.organizationId,
    ...
    getSecurityLogs = async (request, reply) => {
        const user = request.user;
        const query = request.query;
        const filter = {
            organizationId: user.organizationId,
    ...
    getUserLogs = async (request, reply) => {
        const user = request.user;
        const params = request.params;
        const query = request.query;
        const filter = {
    ...
    getResourceLogs = async (request, reply) => {
        const user = request.user;
        const params = request.params;
        const query = request.query;
        const filter = {
