 ...
 */
export async function attachDemoHeaders(request, reply) {
    ...
    if (request.demoUser) {
        ...
        reply.header("X-Demo-Attribution", `${request.demoUser.companyName || "DEMO"} | ${request.demoUser.email} | ${shortSession}`);
    }
}
