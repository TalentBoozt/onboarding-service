...
const DemoFeatureUsageSchema = new Schema({
...
export function getDemoFeatureUsageModel() {
    const conn = getDemoConnection();
    if (conn.models.DemoFeatureUsage) {
        return conn.models.DemoFeatureUsage;
    }
    return conn.model("DemoFeatureUsage", DemoFeatureUsageSchema);
}
