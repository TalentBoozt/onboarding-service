...
const quickLinksStore = new Map();
const getTenantQuickLinks = (tenantId) => {
...
const knowledgeGapsStore = new Map();
const getTenantKnowledgeGaps = (tenantId) => {
...
const buddyStore = new Map();
const getTenantBuddyState = (tenantId, currentUserId) => {
...
export class DemoAppController {
    ...
    logout = async (request, reply) => {
        if (request.demoUser) {
            await demoAuthService.logout(request.demoUser.sessionId, request.demoUser.id, request.demoUser.tenantId);
        }
        return reply.status(200).send({
            success: true,
    ...
    // ==================== JOURNEYS & LMS ====================
    getJourneys = async (request, reply) => {
        const DemoJourney = getDemoJourneyModel();
    ...
    getJourneyById = async (request, reply) => {
    ...
    createJourney = async (request, reply) => {
    ...
    updateJourney = async (request, reply) => {
        const { id } = request.params;
        const body = request.body || {};
        const DemoJourney = getDemoJourneyModel();
        const updated = await DemoJourney.findOneAndUpdate({ _id: id, demoTenantId: new mongoose.Types.ObjectId(request.demoUser.tenantId) }, { $set: body }, { new: true }).lean();
        if (!updated) {
    ...
    deleteJourney = async (request, reply) => {
        const { id } = request.params;
        const DemoJourney = getDemoJourneyModel();
    ...
    duplicateJourney = async (request, reply) => {
        const { id } = request.params;
    ...
    publishJourney = async (request, reply) => {
        const { id } = request.params;
        const DemoJourney = getDemoJourneyModel();
        const updated = await DemoJourney.findOneAndUpdate({ _id: id, demoTenantId: new mongoose.Types.ObjectId(request.demoUser.tenantId) }, {
            $set: {
                status: "published",
                publishing: { status: "published", publishedAt: new Date().toISOString() },
            },
    ...
    archiveJourney = async (request, reply) => {
        const { id } = request.params;
        const DemoJourney = getDemoJourneyModel();
        const updated = await DemoJourney.findOneAndUpdate({ _id: id, demoTenantId: new mongoose.Types.ObjectId(request.demoUser.tenantId) }, {
            $set: {
    ...
    addJourneyModule = async (request, reply) => {
        const { id } = request.params;
        const body = request.body || {};
        const DemoJourney = getDemoJourneyModel();
        const newModule = {
        ...
        const updated = await DemoJourney.findOneAndUpdate({ _id: id, demoTenantId: new mongoose.Types.ObjectId(request.demoUser.tenantId) }, { $push: { modules: newModule } }, { new: true }).lean();
        return reply.status(201).send({ success: true, data: updated });
    };
    assignJourney = async (request, reply) => {
        const { id } = request.params;
        const body = request.body || {};
        const DemoJourney = getDemoJourneyModel();
        ...
        return reply.status(201).send({
            ...
            data: {
                _id: `assign-${Date.now()}`,
                journeyId: id,
                journeyTitle: journey?.title || "Onboarding Journey",
    ...
    bulkAssignJourneys = async (request, reply) => {
        const { id } = request.params;
    ...
    getJourneyAssignments = async (request, reply) => {
        const { id } = request.params;
        const DemoUser = getDemoUserModel();
    ...
    createAssignment = async (request, reply) => {
        const { journeyId, employeeId } = request.body || {};
        const DemoJourney = getDemoJourneyModel();
        ...
        return reply.status(201).send({
            ...
            data: {
                ...
                journey: {
                    ...
                    title: journey?.title || "Onboarding Course",
                    version: 1,
                },
                title: journey?.title || "Onboarding Course",
    ...
    updateLessonProgress = async (_request, reply) => {
        return reply.status(200).send({
            success: true,
    ...
    submitQuiz = async (_request, reply) => {
        return reply.status(200).send({
            success: true,
    ...
    updateTaskStatus = async (request, reply) => {
        const { id } = request.params;
        ...
        const task = await DemoTask.findOneAndUpdate({ _id: id, demoTenantId: new mongoose.Types.ObjectId(request.demoUser.tenantId) }, {
            $set: updateObj,
            $push: {
                statusHistory: {
                    status,
    ...
    addTaskComment = async (request, reply) => {
        const { id } = request.params;
        ...
        const task = await DemoTask.findOneAndUpdate({ _id: id, demoTenantId: new mongoose.Types.ObjectId(request.demoUser.tenantId) }, { $push: { comments: newComment } }, { new: true }).lean();
        return reply.status(201).send({
            success: true,
            data: {
                ...task,
    ...
    updateTaskHardware = async (request, reply) => {
        const { id } = request.params;
        const body = request.body || {};
        const DemoTask = getDemoTaskModel();
        const task = await DemoTask.findOneAndUpdate({ _id: id, demoTenantId: new mongoose.Types.ObjectId(request.demoUser.tenantId) }, { $set: { hardwareMetadata: body } }, { new: true }).lean();
        return reply.status(200).send({ success: true, data: task });
    };
    attachHardwareReceipt = async (request, reply) => {
        const { id } = request.params;
    ...
    getDocumentTemplates = async (request, reply) => {
        const DemoDocument = getDemoDocumentModel();
        const docs = await DemoDocument.find({
            demoTenantId: new mongoose.Types.ObjectId(request.demoUser.tenantId),
        }).lean();
    ...
    createDocumentTemplate = async (request, reply) => {
        const body = request.body || {};
        const DemoDocument = getDemoDocumentModel();
        const DemoActivityLog = getDemoActivityLogModel();
    ...
    updateDocumentTemplate = async (request, reply) => {
        const { id } = request.params;
        const body = request.body || {};
        const DemoDocument = getDemoDocumentModel();
        const updated = await DemoDocument.findOneAndUpdate({ _id: id, demoTenantId: new mongoose.Types.ObjectId(request.demoUser.tenantId) }, { $set: body }, { new: true }).lean();
        return reply.status(200).send({
            success: true,
            data: {
                ...updated,
                _id: id,
                id,
                category: updated?.category || updated?.documentType,
                version: 1,
            },
        });
    };
    deleteDocumentTemplate = async (request, reply) => {
        const { id } = request.params;
        const DemoDocument = getDemoDocumentModel();
    ...
    assignDocument = async (request, reply) => {
        const { templateId, employeeId, dueDate } = request.body || {};
        const DemoDocument = getDemoDocumentModel();
        ...
        return reply.status(201).send({
            ...
            data: {
                ...
                templateTitle: doc?.title || "Standard Document",
                templateVersion: 1,
                employeeId: employeeId || request.demoUser.id,
                assignedBy: "HR Admin",
                status: "pending",
    ...
    getDocumentSignatures = async (request, reply) => {
            ...
            data: [
                {
                    ...
                    templateId: templateId || "tmpl-1",
                    templateTitle: doc?.title || "NDA Agreement",
                    templateVersion: 1,
                    employeeId: {
                        _id: request.demoUser.id,
                        profile: { firstName: "John", lastName: "Doe" },
    ...
    signDocument = async (request, reply) => {
        ...
        let doc = null;
        if (mongoose.Types.ObjectId.isValid(id)) {
            doc = await DemoDocument.findOneAndUpdate({ _id: new mongoose.Types.ObjectId(id), demoTenantId: new mongoose.Types.ObjectId(request.demoUser.tenantId) }, {
                $set: {
                    status: "signed",
                    signedAt: new Date(),
        ...
        if (!doc) {
            doc = await DemoDocument.findOneAndUpdate({ demoTenantId: new mongoose.Types.ObjectId(request.demoUser.tenantId) }, {
                $set: {
                    status: "signed",
                    signedAt: new Date(),
                    signeeName: signerName,
    ...
    getEmailInbox = async (request, reply) => {
    ...
    simulateEmail = async (request, reply) => {
        const { subject, htmlContent } = request.body || {};
        const email = await demoEmailSinkService.captureEmail(request.demoUser.email, subject || "Onboarding Milestone Achieved (Demo Simulation)", htmlContent || "<p>Congratulations! You have completed your first day checklist in the Talnova Demo.</p>", request.demoUser.tenantId, "user_simulated");
        return reply.status(201).send({ success: true, data: email });
    };
    exportControlledData = async (request, reply) => {
        const DemoActivityLog = getDemoActivityLogModel();
        await DemoActivityLog.create({
            demoTenantId: request.demoUser.tenantId,
            demoUserId: request.demoUser.id,
    ...
    getDashboardSummary = async (request, reply) => {
        const tenantId = new mongoose.Types.ObjectId(request.demoUser.tenantId);
        const DemoTask = getDemoTaskModel();
        const DemoUser = getDemoUserModel();
        const DemoDocument = getDemoDocumentModel();
    ...
    getDirectory = async (request, reply) => {
        const DemoUser = getDemoUserModel();
        const users = await DemoUser.find({
            demoTenantId: new mongoose.Types.ObjectId(request.demoUser.tenantId),
        })
    ...
    getKBArticles = async (request, reply) => {
        ...
        if (query.search) {
            ...
            formatted = formatted.filter((a) => a.title.toLowerCase().includes(q) ||
    ...
    getKBArticleById = async (request, reply) => {
        const { id } = request.params;
        const { getDemoKBArticleModel } = await import("../models/index.js");
        const DemoKBArticle = getDemoKBArticleModel();
        let article = null;
    ...
    createKBArticle = async (request, reply) => {
        const body = request.body || {};
        const { getDemoKBArticleModel } = await import("../models/index.js");
        const DemoKBArticle = getDemoKBArticleModel();
        const category = body.category || "Company Policies";
        const textContent = body.content?.blocks?.map((b) => b.content).filter(Boolean).join("\n\n") ||
            body.summary ||
            "";
    ...
    updateKBArticle = async (request, reply) => {
        const { id } = request.params;
        const body = request.body || {};
        const { getDemoKBArticleModel } = await import("../models/index.js");
        const DemoKBArticle = getDemoKBArticleModel();
        ...
        if (body.content?.blocks) {
            updateFields.content = body.content.blocks.map((b) => b.content).filter(Boolean).join("\n\n");
        }
        const updated = await DemoKBArticle.findOneAndUpdate({ _id: id, demoTenantId: new mongoose.Types.ObjectId(request.demoUser.tenantId) }, { $set: updateFields }, { new: true }).lean();
        return reply.status(200).send({
            success: true,
            data: formatKBArticle(updated || { _id: id, ...body }),
        });
    };
    deleteKBArticle = async (request, reply) => {
        const { id } = request.params;
        const { getDemoKBArticleModel } = await import("../models/index.js");
        const DemoKBArticle = getDemoKBArticleModel();
    ...
    publishKBArticle = async (request, reply) => {
        const { id } = request.params;
        return reply.status(200).send({
            success: true,
    ...
    archiveKBArticle = async (request, reply) => {
        const { id } = request.params;
        return reply.status(200).send({
            success: true,
    ...
    getKnowledgeGaps = async (request, reply) => {
    ...
    resolveKnowledgeGapWithQuickAnswer = async (request, reply) => {
        const { id } = request.params;
    ...
    resolveKnowledgeGapWithArticle = async (request, reply) => {
        const { id } = request.params;
    ...
    dismissKnowledgeGap = async (request, reply) => {
        const { id } = request.params;
        const gaps = getTenantKnowledgeGaps(request.demoUser.tenantId);
        const gap = gaps.find((g) => g._id === id);
        if (gap) {
    ...
    triggerReindex = async (_request, reply) => {
        return reply.status(200).send({
            success: true,
    ...
    recordTelemetry = async (request, reply) => {
        const { getDemoFeatureUsageModel } = await import("../models/index.js");
        const DemoFeatureUsage = getDemoFeatureUsageModel();
        const { featureKey, route, action = "view", status = "ALLOWED", durationSeconds = 0, metadata = {} } = request.body || {};
        if (!featureKey || !route) {
    ...
    getCurrentOrganization = async (request, reply) => {
        const DemoTenant = getDemoTenantModel();
        const tenant = await DemoTenant.findById(request.demoUser.tenantId).lean();
        if (!tenant)
            throw new AppError(404, "NOT_FOUND", "Demo company not found.");
        return reply.status(200).send({
            success: true,
            data: {
                _id: tenant._id,
    ...
    updateCurrentOrganization = async (request, reply) => {
        const DemoTenant = getDemoTenantModel();
        const body = request.body || {};
        const updateData = {};
        if (body.name)
        ...
        if (body.supportEmail)
            updateData.contactEmail = body.supportEmail;
        const tenant = await DemoTenant.findByIdAndUpdate(request.demoUser.tenantId, updateData, { new: true }).lean();
        return reply.status(200).send({
            success: true,
    ...
    getDepartments = async (_request, reply) => {
        return reply.status(200).send({
            success: true,
            data: [
    ...
    deleteDepartment = async (_request, reply) => {
        return reply.status(200).send({
            success: true,
            message: "Department removed in demo.",
        });
    };
    getIntegrationCapabilities = async (_request, reply) => {
        return reply.status(200).send({
            success: true,
            data: {
    ...
    getNotificationPreferences = async (_request, reply) => {
        return reply.status(200).send({
            success: true,
            data: {
                categories: {
    ...
    getNotifications = async (_request, reply) => {
        return reply.status(200).send({
            success: true,
            data: [
                {
    ...
    getEmployeeMe = async (request, reply) => {
        const DemoUser = getDemoUserModel();
    ...
    getEmployeeById = async (request, reply) => {
        const { id } = request.params;
        if (id === "me") {
    ...
    getAssignmentsMe = async (request, reply) => {
        const DemoJourney = getDemoJourneyModel();
        const journeys = await DemoJourney.find({
            demoTenantId: new mongoose.Types.ObjectId(request.demoUser.tenantId),
        }).lean();
    ...
    getAssignments = async (request, reply) => {
        return this.getAssignmentsMe(request, reply);
    };
    getManagerDashboard = async (_request, reply) => {
        return reply.status(200).send({
            success: true,
            data: {
    ...
    getManagerTeam = async (request, reply) => {
        const DemoUser = getDemoUserModel();
        const users = await DemoUser.find({
            demoTenantId: new mongoose.Types.ObjectId(request.demoUser.tenantId),
        }).lean();
    ...
    getManagerTeamOverview = async (request, reply) => {
        const DemoUser = getDemoUserModel();
        const users = await DemoUser.find({
            demoTenantId: new mongoose.Types.ObjectId(request.demoUser.tenantId),
        }).lean();
    ...
    getManagerDirectReportDetails = async (request, reply) => {
        const { employeeId } = request.params;
        const DemoUser = getDemoUserModel();
        const user = (await DemoUser.findById(employeeId).lean()) ||
    ...
    getMyBuddyProfile = async (request, reply) => {
    ...
    saveBuddyProfile = async (request, reply) => {
        const state = getTenantBuddyState(request.demoUser.tenantId, request.demoUser.id);
        const body = request.body || {};
        ...
        const updated = {
            ...existing,
            ...body,
            skills: Array.isArray(body.skills) ? body.skills : typeof body.skills === "string" ? body.skills.split(",").map((s) => s.trim()) : existing.skills,
            languages: Array.isArray(body.languages) ? body.languages : typeof body.languages === "string" ? body.languages.split(",").map((s) => s.trim()) : existing.languages,
        };
        state.profiles.set(request.demoUser.id, updated);
        return reply.status(200).send({ success: true, data: updated });
    };
    getMyBuddy = async (request, reply) => {
        const state = getTenantBuddyState(request.demoUser.tenantId, request.demoUser.id);
        // Find assignment where current user is the new hire mentee
        const assignment = state.assignments.find((a) => a.newHireUserId?._id === request.demoUser.id || a._id === "asg-my-buddy") ||
            state.assignments[0] ||
            null;
        return reply.status(200).send({
            success: true,
    ...
    getMyMentees = async (request, reply) => {
        const state = getTenantBuddyState(request.demoUser.tenantId, request.demoUser.id);
        // Find assignments where current user is the mentor
        const mentees = state.assignments.filter((a) => a.buddyUserId?._id === request.demoUser.id || a._id === "asg-mentee-1");
        return reply.status(200).send({
            success: true,
            data: mentees,
        });
    };
    getBuddyAssignments = async (request, reply) => {
        const state = getTenantBuddyState(request.demoUser.tenantId, request.demoUser.id);
        return reply.status(200).send({ success: true, data: state.assignments });
    };
    getAvailableBuddies = async (request, reply) => {
        const state = getTenantBuddyState(request.demoUser.tenantId, request.demoUser.id);
    ...
    assignBuddy = async (request, reply) => {
        const state = getTenantBuddyState(request.demoUser.tenantId, request.demoUser.id);
        const { newHireUserId, buddyUserId, checklistTemplate } = request.body || {};
        const DemoUser = getDemoUserModel();
    ...
    updateBuddyChecklist = async (request, reply) => {
        const { assignmentId } = request.params;
        const { taskId, completed } = request.body || {};
        const state = getTenantBuddyState(request.demoUser.tenantId, request.demoUser.id);
        const assignment = state.assignments.find((a) => a._id === assignmentId);
        if (assignment && assignment.checklist) {
            const task = assignment.checklist.find((t) => t._id === taskId || t.title === taskId);
            if (task) {
    ...
    logBuddyCheckin = async (request, reply) => {
        const { assignmentId } = request.params;
        const { notes, rating, sentiment } = request.body || {};
        const state = getTenantBuddyState(request.demoUser.tenantId, request.demoUser.id);
        const assignment = state.assignments.find((a) => a._id === assignmentId);
        if (assignment) {
            if (!assignment.checkins)
                assignment.checkins = [];
            const newCheckin = {
                _id: `chk-in-${Date.now()}`,
    ...
    addBuddyChecklistTask = async (request, reply) => {
        const { assignmentId } = request.params;
        const { title, stage, description } = request.body || {};
        const state = getTenantBuddyState(request.demoUser.tenantId, request.demoUser.id);
        const assignment = state.assignments.find((a) => a._id === assignmentId);
        if (assignment) {
    ...
    getAuditLogs = async (request, reply) => {
        const DemoActivityLog = getDemoActivityLogModel();
    ...
    getDocumentsInbox = async (request, reply) => {
        const DemoDocument = getDemoDocumentModel();
        const docs = await DemoDocument.find({
            demoTenantId: new mongoose.Types.ObjectId(request.demoUser.tenantId),
        }).lean();
    ...
    getMyMilestones = async (request, reply) => {
        const DemoUser = getDemoUserModel();
        const user = await DemoUser.findById(request.demoUser.id).lean();
        const empIdObj = {
            _id: request.demoUser.id,
    ...
    getTeamMilestones = async (request, reply) => {
        return this.getMyMilestones(request, reply);
    };
    getMilestoneTemplates = async (_request, reply) => {
        const templates = [
            {
                _id: "tmpl-ms-30",
                id: "tmpl-ms-30",
    ...
    createMilestoneTemplate = async (request, reply) => {
        const body = request.body || {};
        return reply.status(201).send({
            success: true,
            data: {
    ...
    updateMilestoneTemplate = async (request, reply) => {
        const { id } = request.params;
        const body = request.body || {};
        return reply.status(200).send({
            success: true,
    ...
    deleteMilestoneTemplate = async (_request, reply) => {
        return reply.status(200).send({ success: true, message: "Milestone template removed." });
    };
    assignMilestone = async (request, reply) => {
        const { templateId, employeeId } = request.body || {};
        return reply.status(201).send({
            success: true,
    ...
    submitMilestoneSelfEvaluation = async (request, reply) => {
        const { id } = request.params;
        const body = request.body || {};
        const DemoActivityLog = getDemoActivityLogModel();
        await DemoActivityLog.create({
    ...
    submitMilestoneManagerReview = async (request, reply) => {
        const { id } = request.params;
        const body = request.body || {};
        const DemoActivityLog = getDemoActivityLogModel();
        await DemoActivityLog.create({
    ...
    requestMilestoneRevision = async (request, reply) => {
        const { id } = request.params;
        return reply.status(200).send({
            success: true,
    ...
    escalateMilestone = async (request, reply) => {
        const { id } = request.params;
        return reply.status(200).send({
            success: true,
    ...
    updateMilestoneGoals = async (request, reply) => {
        const { id } = request.params;
        const body = request.body || {};
        return reply.status(200).send({
            success: true,
    ...
    updateMilestoneStatus = async (request, reply) => {
        const { id } = request.params;
    ...
    getAIConversations = async (_request, reply) => {
        return reply.status(200).send({
            success: true,
            data: [
                {
    ...
    getAIConversationById = async (_request, reply) => {
        return reply.status(200).send({
            success: true,
            data: {
                id: "conv-1",
                ...
                messages: [
                    ...
                    },
                    {
                        id: "m-2",
                        role: "assistant",
                        content: "Under Acme Corp's Remote Work Policy, all full-time employees are eligible for a $1,000 home office equipment reimbursement within their first 90 days. You can submit receipts through the Documents portal.",
    ...
    postAIChat = async (request, reply) => {
        const { message } = request.body || {};
        return reply.status(200).send({
            success: true,
            data: {
                id: `msg-${Date.now()}`,
                role: "assistant",
                content: `[Talnova AI Assistant] Based on Acme Corporation's knowledge base: You asked about "${message || "company policies"}". In the demo environment, all onboarding journeys, compliance guidelines, and role checklists are automatically synthesized.`,
