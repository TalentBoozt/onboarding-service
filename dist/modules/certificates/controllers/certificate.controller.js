...
export class CertificateController {
    ...
    getPublicCertificate = async (request, reply) => {
        ...
        try {
                    ...
                    if (assignment && assignment.status === "completed" && assignment.certificate?.issued) {
                        ...
                        return reply.status(200).send({
                            ...
                            data: {
                                ...
                                recipientName: employee?.profile?.fullName ||
            ...
            const org = await mongoose.model("Organization").findById(certificate.organizationId);
